...
function RepoDashboard() {
  ...
  function goTo(
    section: "commits" | "contributors" | "branches" | "pull-requests",
  ) {
    navigate({
  ...
  const mergeRatePct =
    totalPRs > 0 ? Math.round(((merged ?? 0) / totalPRs) * 100) : null;
    ...
    <div className="p-6">
      <div className="max-w-7xl mx-auto">
        <div className="flex items-center justify-between mb-6">
          <div>
            <h1 className="text-sm font-mono font-bold text-zinc-200">
              {repo?.fullName}
            </h1>
            ...
            <StatTileContent
              ...
              badge={
                summary?.avgCommitsPerWeek != null
                  ? {
                      text: `${summary.avgCommitsPerWeek} avg / week`,
                      variant: "zinc",
                    }
                  : undefined
              }
            ...
            <StatTileContent
              ...
              sub={
                summary?.peakWeek?.week
                  ? `on ${formatWeekLabel(summary.peakWeek.week)}`
                  : "no data yet"
              }
            />
          </DashboardTile>
